...
import { ChannelName, PersosTypes } from '../../player/src/types';
import { INITIAL, PLAY, SEEK, TIME_INTERVAL } from '../../player/src/common/constants';
...
import { StorePersos } from 'legacy/render/create-perso';
